...
public class MainActivity extends AppCompatActivity {
    ...
    public ArrayList<Container> CompletedContainers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnEmptyContainers = findViewById(R.id.btnEmptyContainer);
        listView = findViewById(R.id.listView);
        Containers = new ArrayList<Container>();
        CompletedContainers = new ArrayList<Container>();
        getList();
        ...
        btnEmptyContainers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getEmptyContainerList();
            }
        });
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
    ...
    public void getList() {
        ...
        try {
            ...
            asyncHttpClient.get(BASE_URL + "?region=izmit&lat=40.762844&lon=29.925699", new AsyncHttpResponseHandler() {
                @Override
    ...
    public void getEmptyContainerList() {
        CompletedContainers.clear();
        try {
            asyncHttpClient = new AsyncHttpClient();
            asyncHttpClient.get(BASE_URL + "?completedWithRegion=izmit", new AsyncHttpResponseHandler() {
                @Override
                public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, byte[] responseBody) {
                    String response = new String(responseBody);
                    JSONArray jsonArr = null;
    ...
    public void setList() {
        try {
            listView.setAdapter(new CustomAdapter(this, Containers, true));
        } catch (Exception ex) {
    ...
    public void setEmptyList() {
        try {
            listView.setAdapter(new CustomAdapter(this, CompletedContainers, false));
        } catch (Exception ex) {
            System.out.println(ex);
        }
        System.out.println("setList()");
        System.out.println("Completed Container size: " + CompletedContainers.size());
    }
